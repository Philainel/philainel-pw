...
function Root() {
	...
	return (
		<div id="RootPage" className="flex flex-col gap-2">
			<div className="bg-backgeoundImage-t500 rounded-2xl text-white font-medium backdrop-blur-[100px] py-6 px-5 roundex-2xl">
			...
			<div className="bg-backgeoundImage-t500 rounded-2xl text-white font-medium backdrop-blur-[100px] py-6 px-5 roundex-2xl">
				...
				<div className="grid grid-cols-5 gap-2 items-center mt-2 select-none">
					{links.map(l =>
						<a href={l.href} className="text-2xl bg-white py-1 px-2 flex items-center gap-1 rounded-2xl translate-y-0 hover:-translate-y-1 transition-transform duration-200 ease-in-out" target="_blank" id={l.id}>
